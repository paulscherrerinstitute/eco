...
class Upstream_diagnostic_slits:
    def __init__(self, pvname, name=None,right=None, left=None, up=None, down=None, elog=None):
        self.name = name
        self.Id = pvname
        ...
        def sethpos(x):
            ...
            diff_hpos = x - hpos0 
            return tuple([self.right.get_current_value() + diff_hpos, 
                          self.left.get_current_value() + diff_hpos ])

        def setvpos(x):
            vpos0 = self.vpos.get_current_value()
            diff_vpos = x - vpos0 
            return tuple([self.up.get_current_value() + diff_vpos, 
